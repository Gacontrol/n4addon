...
export const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    inputs: [
      { label: 'Eingang', type: 'input' },
      { label: 'Sperre1', type: 'input' },
      { label: 'Sperre2', type: 'input' },
      { label: 'Sperre3', type: 'input' },
      { label: 'Sperre4', type: 'input' },
      { label: 'Sperre5', type: 'input' },
      { label: 'Sperre6', type: 'input' }
    ],
    outputs: [
      { label: 'Ausgang1', type: 'output' },
      { label: 'Ausgang2', type: 'output' },
      { label: 'Ausgang3', type: 'output' },
      { label: 'Ausgang4', type: 'output' },
      { label: 'Ausgang5', type: 'output' },
      { label: 'Ausgang6', type: 'output' },
      { label: 'Error', type: 'output' }
    ],
    description: 'Parametrierbarer Sequenzbaustein fuer HLK-Anwendungen (WRG, Heizung, Kuehlung)',
    defaultConfig: {
      seqName: '',
      seqCount: 3,
      seq1Name: 'WRG',
